      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-center md:justify-evenly items-center gap-6 md:gap-8 px-4">
          <div className="flex items-center gap-2">
            <Users size={24} className="text-white opacity-90" />
            <span className="text-sm md:text-base">Sleeps 6</span>
          </div>
          
          <div className="flex items-center gap-2">
            <Bed size={24} className="text-white opacity-90" />
          ...
          <div className="flex items-center gap-2">
            <Utensils size={24} className="text-white opacity-90" />
            <span className="text-sm md:text-base">Kitchen</span>
          </div>
          
          <div className="flex items-center gap-2">
            <Sofa size={24} className="text-white opacity-90" />
...
export default PropertyFeaturesBanner;
