...
const LocationCard: React.FC<LocationCardProps> = ({ title, description, imageSrc, icon: Icon }) => {
  return (
    <Card className="overflow-hidden shadow-lg rounded-xl transition-all duration-300 hover:shadow-xl">
      ...
      <CardContent className="p-6">
        <div className="flex items-center gap-2 mb-3">
          <Icon className="text-[#6E59A5]" size={20} />
          <h3 className="text-xl font-normal text-[#6E59A5]">{title}</h3>
        </div>
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-light text-center mb-12 text-[#1A1F2C]">
          Discover<span className="text-[#6E59A5]">...</span>
        </h2>
